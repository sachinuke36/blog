...
const BlogCard = ({ blog }: { blog: Blog }) => {
    ...
    return (
        <Card className='flex flex-col h-[250px] w-[300px] sm:w-[350px] border-none text-white shadow shadow-orange-300 gap-1 sm:gap-3 bg-[#353535ee]' >
            <div className='px-2'>
            ...
            <div className='px-2  flex gap-2'>{blog.tags.filter((tag, i) => i < 3).map((tag, i) => <p key={i} className='text-[10px] shadow-purple-300 shadow-sm flex items-center justify-center bg-[#121111] px-1'>{tag}</p>)}</div>
